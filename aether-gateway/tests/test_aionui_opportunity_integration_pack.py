...
def test_native_opportunity_integration_pack_has_bounded_ipc_and_no_renderer_secret():
    root = Path(__file__).resolve().parents[2] / "aionui-integration"
    required = [
        "packages/desktop/src/common/aetherOpportunityTypes.ts",
        ...
        "packages/desktop/src/renderer/pages/opportunity-intelligence/useAetherOpportunity.ts",
        "packages/desktop/src/renderer/pages/opportunity-intelligence/OpportunityIntelligence.module.css",
    ...
    assert bridge.count("ipcMain.handle") == 6
